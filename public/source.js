 ...
 * Functions to be executed at the end of each tick
 */
const tickHandlers = []

/**
 * @type Array<VoidFunction>
 * Functions to be executed at the start of each tick
 */
const firstTickHandlers = []
...
setInterval(() => {
    // CMRLoader First Ticking Logic (CFTL)
    firstTickHandlers.forEach((v) => v())
    ...
    // CMRLoader Ticking Logic (CTL)
    tickHandlers.forEach((v) => v())
}, 1000 / o.tps);